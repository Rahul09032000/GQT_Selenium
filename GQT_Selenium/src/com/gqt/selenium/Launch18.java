// WAS to navigate to Facebook application and click on "Forgotten Password?" Link using "Linktext" locator
...
public class Launch18 {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		WebElement f_p = driver.findElement(By.linkText("Forgotten password?"));
		f_p.click();
	}
}
