// WAS to open Chrome Browser and navigate to Facebook application and type email using css Selectors [tag class and attribute]
...
// Tag - input, class = inputtext, attribute - name
